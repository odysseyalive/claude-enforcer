...
4. This gate asks about the disclaimer ONLY — it never mentions models beyond the verbatim disclaimer text and never asks the user to switch anything. The first three bullets are the sacred minimum content, verbatim; the fourth and fifth are machinery disclosure for informed consent (the fifth announces the Step 0.2 backup offer and the clean-uninstall/restore it enables, per the 2026-06-24 Backup Offer directive).
<!-- END ENFORCEMENT ANNOTATION -->
